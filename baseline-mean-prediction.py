...
# Calculate the mean and median of the training set scores
mean_score = y_train.mean()
median_score = y_train.median()

# Create predictions using the mean and median
mean_predictions = [mean_score] * len(y_test)
median_predictions = [median_score] * len(y_test)

# Calculate MSE and R-squared for mean predictions
mse_mean = mean_squared_error(y_test, mean_predictions)
r2_mean = r2_score(y_test, mean_predictions)

# Calculate MSE and R-squared for median predictions
mse_median = mean_squared_error(y_test, median_predictions)
r2_median = r2_score(y_test, median_predictions)

print("Baseline Mean Predictions: MSE =", mse_mean, ", R-squared =", r2_mean)
print("Baseline Median Predictions: MSE =", mse_median, ", R-squared =", r2_median)